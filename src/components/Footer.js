    ...
    return ( 
        <footer className="footer-main">
            <div className="container info-container">
                <blockquote>Desarrollado por Camilo Zaque</blockquote>
                <div className="icons">
                    <Link to="/">
                    ...
                    <Link to="/">
                        <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-brand-facebook" width="30" height="30" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#ffffff" fill="none" strokeLinecap="round" strokeLinejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
